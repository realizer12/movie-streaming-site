...
$update="UPDATE movieblog SET title ='$title', content='$content', checkimg='$imgcheck' where idnum ='$number'";
...
if($result1){
  ...
  echo "<meta http-equiv='refresh' content='0;url=readmovieblog.php?number=$number&pagenum=$pagenum'>";
}else{
