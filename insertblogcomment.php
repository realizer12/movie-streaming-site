...
$max_thread_result = mysqli_query($conn,"SELECT max(grp) FROM blogcomment");
...
$result=mysqli_query($conn,"INSERT INTO blogcomment (commentxt,grp,seq,lvl,wirter,articlenum,ddate) VALUES('$content','$max_thread',0,0,'$commentwriter','$articlenumber',UNIX_TIMESTAMP())");
