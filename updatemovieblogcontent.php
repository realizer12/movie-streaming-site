...
$page=$_GET[page];
$conn = mysqli_connect($mysql_host, $mysql_user, $mysql_password,$mysql_db);
$sql3 = "select*from movieblog where idnum='$number'";
...
<form id="boardform"onsubmit="return checkboardbeforeupload();" action="updatemovieblog.php" method="post">
<div id="titledivforboard" style="margin-top:-20px;">
  ...
  <input type="text" style="margin-right: 5px;margin-top: 10px;font-size:18px; width:400px; " maxlength="20" placeholder="제목은 20자내외로 적으세요!"   name="titleofboard1" id="titleofboard1" value="<?php echo $rows3['title']; ?>">
</div>
