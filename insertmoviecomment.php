...
$max_thread_result = mysqli_query($conn,"SELECT max(grp) FROM moviecomment");
...
$result=mysqli_query($conn,"INSERT INTO moviecomment (commentxt,grp,seq,lvl,writer,movienumber,wdate) VALUES('$content','$max_thread',0,0,'$commentwriter','$articlenumber',UNIX_TIMESTAMP())");
