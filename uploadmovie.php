...
<div id="moviuploadtitle">
  <font style="font-size:60px;">영화 업로드</font></br>
  <font style="font-size:30px;">순서대로 폼을 완성하세요!</font>
</div>
   ...
   //영화 포스터 올리고 미리보기 윈한 자바 스크립트 이다.
     ...
     function uploadmoviewithajax() {
      ...
      if(title.value==""){
        ...
        alert("영화의 장르를 선택하세요!");
        return false;
        }else if(movieposterimg.value==""){

        alert("영화 포스터를  올리세요!");
        return false;
        }else if(movievideofile.value==""){
         alert("영화 영상 파일을 올리세요!");
         return false;
...
<div class="modal" id="uploadpregressbar" style="display:none;">
  <div id="show_pregressbar" class="progress"style="width:100%; height:200px; margin-top: 180px;color:white; background-color:black">
    <font style="font-size:50px;">현재 영화를 업로드 중입니다.! 잠시만 기다려주세요!</font><br>
...
<form id="uploademovieform" name="uploademovieform"  method="post" enctype="multipart/form-data">
    ...
    <input type="text" id="movietitleinput" name="movietitleinput"  style="width:500px; border: 2px solid #1d0606; font-size:22px;" placeholder=" 영화 제목을 입력하세요!" value="">
    <br>
    <br>
    <br>
    ...
    <div style="width:180px; height:250px; margin-left: 40px; margin-top: 10px; margin-bottom: 5px;border: 2px solid #1d0606;"id="posterimageholder">
     <img src="webimage/noimage.png" id="psterimagepreview" style="width:176px; height:246px;" alt="">
    </div>
    ...
    <br>
    <textarea name="moviesummary" id="moviesummary" maxlength="500" placeholder=" 영화 소개글은 최대 500자 까지입니다." style="margin-left: 50px;border: 2px solid #1d0606;font-size: 20px;height:300px;  resize:none; width:1100px;"></textarea>
    <br>
