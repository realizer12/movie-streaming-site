...
<form id="boardform"onsubmit="return checkboardbeforeupload();" action="uploadboardwriting.php" method="post">
<div id="titledivforboard" style="margin-top:-20px;">
  <label for="titleofboard" style="font-size:30px;">질문 제목:</label>
